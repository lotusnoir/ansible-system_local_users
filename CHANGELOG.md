...
## [3.2.1](https://github.com/lotusnoir/ansible-system_local_users/compare/3.2.0...3.2.1) - 2025-11-29

### Commits

- add no changes on run flag to keep idempotence [`0b97a6e`](https://github.com/lotusnoir/ansible-system_local_users/commit/0b97a6e6da550ba7aecf85b5823894d9bebb77fe)

## [3.2.0](https://github.com/lotusnoir/ansible-system_local_users/compare/3.1.0...3.2.0) - 2025-11-25

### Commits

- update main to include success flag at the end to be able to monitor last playbook run [`b9d2b1c`](https://github.com/lotusnoir/ansible-system_local_users/commit/b9d2b1c5486f4eaee2d3d7271e48ff9da22a6f63)
